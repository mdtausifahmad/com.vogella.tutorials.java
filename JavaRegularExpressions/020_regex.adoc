...
|`[^abc]`
|When a caret appears as the first character inside square
brackets,
it
...
|`[a-d1-7]`
|Ranges: matches a letter between a and d and figures from 1
to 7,
but not d1.
...
|`XZ`
|Finds X directly followed by Z.</entry>

|`$`
|Checks if a line end follows.</entry>
|===
...
|`\S+`
|Several non-whitespace characters</entry>
