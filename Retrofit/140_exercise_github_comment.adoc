...
As Retrofit (de)serializes all fields based on their name and as we don't want to use _body_ as the field name in out GithubIssue class, we use the `@SerializedName` annotation.
