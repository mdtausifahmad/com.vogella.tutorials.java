...
Create a XML menu resource similar to the following called _main_menu.xml_ and put it into the _menu_ folder, which you should find in the _res_ folder (create the folder if you could not find it).
