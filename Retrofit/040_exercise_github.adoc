...
To use Retrofit in your application, add the following dependency to your build.gradle file_

[source,gradle]
----
include::res/github/build.gradle[]
----

		
Add the permission to access the Internet to your manifest file._
