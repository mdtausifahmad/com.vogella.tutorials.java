...
The results will then be printed on the console.

=== Project creation and setup

Create a new Java application with the name _GerritJava_. 
Add a new (default) package to _src/main/java_ with the name _com.vogella.java.retrofitgerrit_.
